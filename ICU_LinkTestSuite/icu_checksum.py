...
def crc16_checksum(data_without_checksum: bytes):
    crc_reg = 0xFFFF
    length = len(data_without_checksum)
...
def clac_checksum(data_without_checksum: bytes):
    ...
    return crc16_checksum(data_without_checksum)


if __name__ == "__main__":
    # crc16 result should be 0x241A
    skdebug('result:', hex(crc16_checksum(b'\xaa\x55\x00\x16\x80\x31\x00\x00')))
    pass
